...
('Alice', 'Johnson', 'user.1@user.com', '416-555-1001', 'alicej', '$2a$12$Mq8.nED.wVD6vazITcw4uesozxbcw364ewe29V3meAf439NlJlAq6', '123 Queen St W, Toronto, ON'),
('Bob', 'Smith', 'user.2@user.com', '416-555-1002', 'bobsmith', '$2a$12$Mq8.nED.wVD6vazITcw4ue7lN/rgJ/1nK.vyl99e2lYKC31KcMKI2', '456 King St E, Toronto, ON'),
('Carol', 'Lee', 'user.3@user.com', '416-555-1003', 'caroll', '$2a$12$Mq8.nED.wVD6vazITcw4ueHYFLhNLv6wGb5oSH2GLLdUT8K6A.b12', '789 Bloor St W, Toronto, ON'),
('David', 'Nguyen', 'user.4@user.com', '647-555-1004', 'davidn', '$2a$12$Mq8.nED.wVD6vazITcw4ueS74r1zC0lm9rXv.mTIUTeY7A2KlMsIa', '321 Yonge St, Toronto, ON'),
('Eva', 'Martinez', 'user.5@user.com', '647-555-1005', 'evam', '$2a$12$Mq8.nED.wVD6vazITcw4ueVZehJXQaOiO1m5V2a9aT/9TsKayjT7m', '654 Parliament St, Toronto, ON'),
('Frank', 'Brown', 'user.6@user.com', '416-555-1006', 'frankb', '$2a$12$Mq8.nED.wVD6vazITcw4ue5arB2GZ39067PIbkv6HHo3ABas.7zay', '987 Spadina Ave, Toronto, ON'),
('Grace', 'Davis', 'user.7@user.com', '647-555-1007', 'graced', '$2a$12$Mq8.nED.wVD6vazITcw4ueY2jAgarvlDjTwHhEgCrJdKflPXjnhLi', '159 College St, Toronto, ON'),
('Henry', 'Wilson', 'user.8@user.com', '416-555-1008', 'henryw', '$2a$12$Mq8.nED.wVD6vazITcw4ueJS8.LFz8heJxGI/fzBz1AbyE1LbDZoi', '753 Dundas St W, Toronto, ON'),
('Ivy', 'Taylor', 'user.9@user.com', '647-555-1009', 'ivyt', '$2a$12$Mq8.nED.wVD6vazITcw4ue3e72cysp.36Da1VYzUB0BfabZ6fbuSy', '852 Queen St E, Toronto, ON'),
('Jack', 'Anderson', 'user.10@user.com', '416-555-1010', 'jacka', '$2a$12$Mq8.nED.wVD6vazITcw4ueaSrA4gdPlbNMl3HqpWgRv.mT.ryIAlS','951 King St W, Toronto, ON');
